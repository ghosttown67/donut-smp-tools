...
public class OneByOneHolesESP extends Module {
    ...
    public OneByOneHolesESP() {
        super(DonutSMPTools.BASE_HUNTING_CATEGORY, "OneByOneHolesESP", "Highlights 1x1x1 air holes that are likely player-made.");
    }
    ...
    private void scanChunk(WorldChunk chunk) {
        ...
        if (chatNotifications.get() && newHoles > 0) {
