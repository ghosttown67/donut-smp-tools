...
public class HoleTunnelStairsESP extends Module {
    ...
    private final Setting<Integer> maxChunks = sgGeneral.add(new IntSetting.Builder()
        ...
        .description("Chunks per tick - LOWER FOR LESS LAG (recommended: 2)")
        .defaultValue(2)
        .min(1)
        .sliderRange(1, 20)
        .build()
    ...
    public HoleTunnelStairsESP() {
        super(DonutSMPTools.BASE_HUNTING_CATEGORY, "hole-tunnel-stair-esp", "Finds and highlights holes and tunnels and stairs.");
    }
