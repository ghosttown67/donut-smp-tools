package com.donutsmp.addon.hud;
...
public class HudExample extends HudElement {
     ...
     */
    public static final HudElementInfo<HudExample> INFO = new HudElementInfo<>(DonutSMPTools.HUD_GROUP, "example", "HUD element example.", HudExample::new);
